...
import os
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/hannahlee/terrarunner/keys/my-credentials.json"
# Initialize a storage client
storage_client = storage.Client()
print("Storage client initialized.")
# Get your bucket
bucket = storage_client.get_bucket('abiding-kingdom-447001-e7-nytaxi')
